...
class ShareSearchLocators:
    ...
    LOCATOR_LOGIN_FIELD = (By.XPATH, '/html/body/center/table/tbody/tr[3]/td/table/tbody/tr/td[1]/p/input')
    LOCATOR_PASSWorD_FIELD = (By.XPATH, '/html/body/center/table/tbody/tr[3]/td/table/tbody/tr/td[2]/p/input')
    LOCATOR_LOGIN_BTN = (By.XPATH, '/html/body/center/table/tbody/tr[3]/td/table/tbody/tr/td[3]/input')
    LOCATOR_AUTORIZATION_MESS = (By.XPATH, '/html/body/center/table/tbody/tr[1]/td/table/tbody/tr/td[2]/span')
...
class RegisterHelp(BasePage):
    ...
    def filling_out_reg_form(self):
        ...
        return reg_message2, reg_message3

    def autorization_user(self, login, password):
        login_field = self.find_element(ShareSearchLocators.LOCATOR_LOGIN_FIELD)
        login_field.send_keys(login)
        password_field = self.find_element(ShareSearchLocators.LOCATOR_PASSWorD_FIELD)
        password_field.send_keys(password)
        login_btn = self.find_element(ShareSearchLocators.LOCATOR_LOGIN_BTN)
        login_btn.click()
        message = self.find_element(ShareSearchLocators.LOCATOR_AUTORIZATION_MESS).text
        time.sleep(3)
        return message